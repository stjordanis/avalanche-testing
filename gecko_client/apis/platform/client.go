...
// AddValidator issues a transaction to add a primary subnet validator and returns the txID
...
// AddDelegator issues a transaction to add a primary subnet delegator and returns the txID
...
// AddSubnetValidator issues a transaction to add a non-primary subnet validator to subnet with ID [subnetID] and returns the txID

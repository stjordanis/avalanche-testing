...
// NewAdminRPCxecutor returns a new admin rpc test adminRPCExecutor
func NewAdminRPCxecutor(clients []*apis.Client, numTxs, txFee uint64, acceptanceTimeout time.Duration) tester.AvalancheTester {
	return &adminRPCExecutor{
...
func (e *adminRPCExecutor) ExecuteTest() error {

...
func (test StakingNetworkAdminRPCTest) Run(network networks.Network, context testsuite.TestContext) {
	...
	// Execute the admin rpc test
	executor := NewAdminRPCxecutor(clients, test.NumTxs, test.TxFee, test.AcceptanceTimeout)
	logrus.Infof("Executing admin rpc test...")
...
func (test StakingNetworkAdminRPCTest) GetNetworkLoader() (networks.NetworkLoader, error) {
...
func (test StakingNetworkAdminRPCTest) GetExecutionTimeout() time.Duration {
	return 10 * time.Minute
}

// GetSetupBuffer implements the Kurtosis Test interface
func (test StakingNetworkAdminRPCTest) GetSetupBuffer() time.Duration {
